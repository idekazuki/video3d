...
def parse_opts():
    ...
    parser.add_argument('--class_type', default='verb', type=str, help='verb, noun, verb+noun')
    ...
    parser.add_argument('--horizon', action='store_true', help='If ture, horizon flip 0.5')
    parser.set_defaults(verbose=True)
    parser.add_argument('--normalization', action='store_true', help='If ture, normalization RGB')
    parser.set_defaults(verbose=True)
